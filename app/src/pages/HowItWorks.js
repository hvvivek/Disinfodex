    ...
    return (<>
        ...
        <div style={{"display":"flex", "justifyContent":"center", "margin":"2rem"}} id="home">
                    <div style={{"width":"90%"}}>
                        ...
                        <p>Disinfodex is a small-scale and mostly volunteer-led project. As of November 2020, our funding comes from the <a href="https://miamifoundation.org/" target="_blank" rel="noreferrer">Miami Foundation</a> and the <a href="https://carnegieendowment.org/specialprojects/counteringinfluenceoperations" target="_blank" rel="noreferrer">Carnegie Endowment for International Peace’s Partnership for Countering Influence Operations</a>. We have also benefited from support from the <a href="https://cyber.harvard.edu/" target="_blank" rel="noreferrer">Harvard Berkman Klein Center</a>’s <a href="https://www.berkmankleinassembly.org/" target="_blank" rel="noreferrer">Assembly program</a>.</p>                    
                        </div>
                    </div>
                </div>
